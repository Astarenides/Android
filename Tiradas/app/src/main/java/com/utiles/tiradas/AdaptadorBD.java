...
public class AdaptadorBD {
	public static final String DATABASE_NAME = "tiradas";
	...
	public AdaptadorBD abrir() throws SQLException {
		File localFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/data/com.utiles.tiradas/databases");
		localFile.mkdirs();
		db = SQLiteDatabase.openDatabase(new File(localFile, "/tiradas").toString(), null, 0);
		return this;
	}
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		DatabaseHelper(Context paramContext) {
			super(paramContext, "tiradas", null, DATABASE_VERSION);
		}
