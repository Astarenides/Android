package com.pruebas.horasextra.adapter;
...
import com.pruebas.horasextra.R;

/**
 * Created by fhidalgo on 24/05/2016.
 */
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        } else if (viewType == TYPE_HEADER) { //inflate your layout and pass it to view holder
